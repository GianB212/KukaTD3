...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, env_low=-1, env_high=1, gamma=0.99, update_actor_interval=2, warmup=1000, n_actions=2, max_size=1000000, layer1_size=400, layer2_size=300, batch_size=100, noise=0.1):
        self.alpha = alpha
        self.beta = beta
        self.gamma = gamma
        self.tau = tau
        self.max_action = env_high
        self.min_action = env_low
